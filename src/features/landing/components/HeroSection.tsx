...
const HeroStatsCard = () => (
  <div className="bg-brand-dark-card relative w-full rounded-3xl border border-white/10 p-6 sm:p-8">
...
export const HeroSection = () => (
  <section className="bg-brand-dark relative flex min-h-screen items-center overflow-hidden pt-16">
    ...
    <div className="relative mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 sm:py-20 md:px-10 md:py-0">
      <div className="grid items-center gap-12 md:grid-cols-2">
        ...
        <div>
          ...
          <h1 className="font-display text-[clamp(2rem,7vw,5rem)] leading-[1.05] font-medium tracking-tight text-white">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:mt-10 sm:flex-row">
            <Link
              to={ROUTES.REGISTER}
              className="bg-primary flex items-center justify-center gap-2 rounded-full px-7 py-3.5 text-sm font-medium text-white transition-opacity hover:opacity-90 sm:text-base"
            >
            ...
            <Link
              to={ROUTES.REGISTER}
              className="flex items-center justify-center gap-2 rounded-full border border-white/20 px-7 py-3.5 text-sm text-white transition-colors hover:border-white/40 hover:bg-white/5 sm:text-base"
            >
              Partner with Us
            </Link>
          </div>
          ...
          <div className="mt-10 flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:gap-6">
            ...
            <div>
              ...
              <p className="text-sm text-white/60">
                Loved by <span className="font-semibold text-white">100+</span> diners
              </p>
            </div>
          </div>
        </div>
