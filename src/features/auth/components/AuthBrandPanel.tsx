...
export const AuthBrandPanel = ({ heading, subheading }: AuthBrandPanelProps) => (
  <div className="relative hidden flex-col justify-between overflow-hidden bg-[#0D0D0B] p-8 lg:flex lg:p-10">
    ...
    <div
      aria-hidden="true"
      className="pointer-events-none absolute -right-16 -top-16 size-72 rounded-full bg-[#FF5900] opacity-20 blur-3xl"
    />

    {/* Main copy */}
    <div className="relative z-10 space-y-4">
      <p className="text-xs font-semibold uppercase tracking-widest text-[#FF5900]">
        The dining platform
      </p>
